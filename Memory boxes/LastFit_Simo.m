...
dataType = 'E4';
plotOutputNoNDtimeChooseReadoutTime(p, dataType, subjectNumber, readoutTime, ['results/figures_report/E4_informed_', num2str(p)]);

dataType = 'E8';
plotOutputNoNDtimeChooseReadoutTime(p, dataType, subjectNumber, readoutTime, ['results/figures_report/E8_informed_', num2str(p)]);

dataType = 'E18';
plotOutputNoNDtimeChooseReadoutTime(p, dataType, subjectNumber, readoutTime, ['results/figures_report/E18_informed_', num2str(p)]);
