function pOptimized = fitParametersWongWang(dataType, subjectNumber)
...
p0 = 0.25*ones(1,3);                     % initial parameters (but see function pTranform)

options = optimset('DiffMinChange', 0.1, 'DiffMaxChange', 10, 'MaxFunEvals', 400);

pOptimized = fminsearchOS('errorFitWongWang', p0, options, data, dataType);
